...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Ctrl | Ctrl |  GUI |  ALt | ||||||| Lower| Space| Bksp|||||||| Tab | Enter| Raise|||||||| Meta | Alt | GUI | Ctrl |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_LCTL, KC_LGUI, KC_LALT,             LOWER,   KC_SPC ,KC_BSPC,         KC_TAB, KC_ENT , RAISE,            KC_RGUI, KC_RALT, KC_RGUI,   KC_RCTL\
  ),
